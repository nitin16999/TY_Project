              ...
              <LinearGradient colors={['#2e3e50', '#232f34']}>
                ...
                </View>
                {
                  this.state.threeMeal ?
                    <View>
                      <View flexDirection='row' style={{ marginBottom: 15, marginTop: 5 }}>
                        <Text style={{ fontSize: 18, color: '#fff', paddingLeft: 20 }}>Breakfast(Per Day): ~</Text>
                      ...
                      <View flexDirection='row' style={{ marginBottom: 15, marginTop: 5 }}>
                        <Text style={{ fontSize: 18, color: '#fff', paddingLeft: 20 }}>Lunch(Per Day): ~</Text>
                      ...
                      <View flexDirection='row' style={{ marginBottom: 15, marginTop: 5 }}>
                        <Text style={{ fontSize: 18, color: '#fff', paddingLeft: 20 }}>Dinner(Per Day): ~</Text>
                ...
                }
                {
                  this.state.fourMeal ?
                    <View>
                      ...
                      <View flexDirection='row' style={{ marginBottom: 15, marginTop: 5 }}>
                        <Text style={{ fontSize: 18, color: '#fff', paddingLeft: 20 }}>Morning snack(Per Day): ~</Text>
                ...
                }
                {
                  this.state.fiveMeal ?
                    <View>
                      ...
                      <View flexDirection='row' style={{ marginBottom: 15, marginTop: 5 }}>
                        <Text style={{ fontSize: 18, color: '#fff', paddingLeft: 20 }}>Afternoon snack(Per Day): ~</Text>
                        <Text style={{ fontSize: 18, fontWeight: 'bold', color: '#fff' }}> {(this.state.BMR * this.state.exerciseTypeValue + this.state.Calorie * 0.07).toFixed(0)} Kcal/day</Text>
                      </View>
                      <View flexDirection='row' style={{ marginBottom: 15, marginTop: 5 }}>
                        <Text style={{ fontSize: 18, color: '#fff', paddingLeft: 20 }}>Dinner(Per Day): ~</Text>
